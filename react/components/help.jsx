      ...
      <div className="content">
        ...
        <ol className="helpList">
          <li className="is-size-5 is-size-6-mobile">
            In our <a>discover</a> page, find one of our guides that you want to
            speak to.
          </li>
          <li className="is-size-5 is-size-6-mobile">
            Refill your <a>balance</a> to at least $60 before booking a session.
            All of our guides cost $60 an hour.
          </li>
          <li className="is-size-5 is-size-6-mobile">
            Write down any questions you might have in a new questionnaire
            document and send it to your guide so they can prepare. You can send
          ...
          <li className="is-size-5 is-size-6-mobile">
            ...
            the session time to cancel your booking in <a>appointments</a>.
          </li>
          <li className="is-size-5 is-size-6-mobile">
          ...
          <li className="is-size-5 is-size-6-mobile">
            ...
            if your <a>balance</a> does not have enough to extend a session
